...
/**
 * Federal civil litigation — US federal court dockets.
 *
...
const tools: McpToolExport['tools'] = [
  {
    ...
    summary: 'US federal civil court cases matching a keyword search, from the federal courts\' case data.',
    inputSchema: {
      type: 'object',
      properties: {
        party: { type: 'string', description: 'Party name or a distinctive part of it, e.g. "Monsanto".' },
        court: { type: 'string', description: 'Optional federal district id, e.g. "cand", "nysd", "ilnd".' },
...
const FILTERS = { court_class: 'federal_district', is_criminal: false };
